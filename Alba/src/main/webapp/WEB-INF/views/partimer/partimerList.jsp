...
<body>
<div id="container" class="w3-main w3-content w4-padding" style="max-width:1200px;width:1000px;">
 <!-- 검색박스 -->
        ...
        <div class="col-md-5" >
            <div id="custom-search-input" >
                <div class="input-group col-md-11">
                    <input type="text" class="form-control input-lg" placeholder="아이디와 이름으로 검색하세요" id="search" name="search" />
...
<c:forEach var="pp" items="${Apple}">
   ...
   <tr onclick="location.href='pdetail?pid=${pp.pid}'" >
